...
public class UploadConfirmFragment extends Fragment {
    ...
    private void Dialogforfacebook(){
		...
		/** show a dialog for user*/ 
		 firsttime = 1;
		mDialog = new DlgWindow1(getActivity(), R.style.CustomDialog, "Fans can go to the press after the praise prizes have qualifications", "Cancel", "OK", new OnClickListener() {
			//粉絲團
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
