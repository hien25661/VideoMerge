            ...
            case LIKE_ACTIVITY_RESULT_CODE:{
            	if (resultCode == -1 /*RESULT_OK*/){
            		...
            		if (liked) {
    					...
    					mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "You are a fan panel members！", "OK", new OnClickListener() {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if (mResult.toUpperCase().equals("YES")) {
				mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "Hide unlocked version", "OK", new OnClickListener() {
				...
				mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "Not added fans", "OK", new OnClickListener() {
