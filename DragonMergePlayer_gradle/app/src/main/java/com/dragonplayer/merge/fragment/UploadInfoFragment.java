    	...
    	btnRegister.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (username.isEmpty() || tel.isEmpty() || email.isEmpty()) {
					...
					mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "Field position non-blank", "Confirm", new OnClickListener() {
				...
				if (tel.length()<7) {
					mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "Phone import mistake", "Confirm", new OnClickListener() {
				...
				if (!isValidVerification(email)) {
					mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "ID number error", "Confirm", new OnClickListener() {
				...
				mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "After uploading the content can not be modified", "Confirm", new OnClickListener() {
					...
					public void onClick(View v) {
	    		        ...
	    		        if (!isInternet) {
	    					mDialog = new DlgWindow4(getActivity(), R.style.CustomDialog, "Please check your Internet connection", "Confirm", new OnClickListener() {
